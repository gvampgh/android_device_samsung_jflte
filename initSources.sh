...
repopick 230259; # SystemUI: Add tunables for clock position
repopick 230260; # SystemUI: Add tunables for clock AM/PM style
repopick 230261; # Tuner: Move clock seconds option to status bar settings
repopick 230262; # SystemUI: Fix clock icon blacklist handling
...
repopick -c 13 226647; # libbt-qcom: Allow building without proprietary bits
...
repopick 230263; # sdk: Update default clock position
